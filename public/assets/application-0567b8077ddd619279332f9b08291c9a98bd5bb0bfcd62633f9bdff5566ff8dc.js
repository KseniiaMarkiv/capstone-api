...
(function() {
    ...
    var myApp = angular.module("spa-demo.authn", ['spa-demo.config'])
    myApp.config('AuthnConfig', ['$authProvider', 'spa-demo.config.APP_CONFIG', function($authProvider, APP_CONFIG) {
