...
(function() {
    ...
    angular
        .module("spa-demo.subjects")
        .controller('ImagesAuthzController', ['$scope', 'Authn', function($scope, Authn) {
            var vm = this;
            vm = {};
            ...
            vm.canUpdate = false;
            vm.canDelete = false;
            vm.canGetDetails = false;
            vm.canUpdateItem = canUpdateItem;
            ...
            function newUser(user, prevUser) {
                ...
                vm.canQuery = true;
                vm.authenticated = Authn.isAuthenticated();
                if (vm.authenticated) {
                    vm.canCreate = true;
                    vm.canUpdate = true;
                    vm.canDelete = true;
                    vm.canGetDetails = true;
                } else {
                    resetAccess();
                }
            }
