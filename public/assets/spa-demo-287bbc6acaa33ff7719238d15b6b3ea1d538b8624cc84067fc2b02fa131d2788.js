...
(function() {
  ...
  angular
    ...
    .constant('APP_CONFIG', {
      ...
      'image_selector_html': "/assets/spa-demo/subjects/images/image_selector-3c9a4bf47a89c6c3d653fa3f89419244d4158ac90ae03221f92d75fa9dba74a5.html",
...
(function() {
    ...
    var myApp = angular.module("spa-demo.subjects")
    myApp.directive("sdImagesAuthz", function() {
        var directive = {
            bindToController: true,
            controller: 'spa-demo.subjects.ImagesAuthzController',
            controllerAs: "vm",
            restrict: "A",
            scope: {
                authz: "="
...
(function() {
    ...
    var myApp = angular.module("spa-demo.subjects")
    myApp.controller('ImagesAuthzController', ['$scope', 'Authn', function($scope, Authn) {
        var vm = this;
        vm.authz = {};
